...
export default function LeadFlowDemo({customClass='bg-gradient-black-purple', title='We Grow your Audience for you.', subtext='Get your free landing page, or a fully packaged online traffic system.'}: BtnsProps) {
