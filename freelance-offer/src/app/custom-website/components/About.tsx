...
export default function About() {
  ...
  <section className="bg-gradient-black-dark pb-10 hero-section section-half-height py-4 flex flex-col md:flex-row items-center justify-center h-screen text-center md:text-left px-2 md:px-6 gap-8">
    {/* Left: Image */}
    ...
    <motion.div className="w-full md:w-1/2 relative z-1"
      initial="hidden"
        ...
        variants={{
          ...
          <h1 className="hero-title text-white drop-shadow-md mb-4">
       {language === 'es' ? 'La solución que necesitas' : 'Exactly what you need and more'}
      </h1>
      <p className="hero-subtitle text-green-200 max-w-xl text-lg">
 You’ll get a web page, first month free to see if you like it.  Fully setup by an experienced and certified professional, as well as the ability to customize the content of the site fully to your liking. 
    <span className="flex mt-2">You get to plug your offer into it, plus a free 20-minute consult to map your funnel and quick wins. </span>
</p>
  ...
  <HelperBtnGroup />
    ...
    >
      ...
      <div className="max-w-5xl mx-auto  flex flex-col items-center justify-between gap-12 md:flex-row z-10 pt-8 pb-8">
        ...
        >
          <h2 className="text-3xl font-bold text-black  mb-4">
            {language === 'es' ? '¿Por qué es gratis?' : 'What you get'}
          </h2>
          <p className="text-lg text-black ">
            You get real value upfront; a web page you can use and customize immediately, plus a quick consult to help you get clarity on your next steps.
            <span className="flex mt-2">
